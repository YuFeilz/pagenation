  jQuery.fn.pagination = function(pno, psize, head) {
      ...
      // alert(num)
      //总页数 
      totalP = (num / pageS) > parseInt(num / pageS) ? parseInt(num / pageS) + 1 : parseInt(num / pageS);
      var currentPage = pno; //当前页数
      var startRow = (currentPage - 1) * pageS; //开始行 
      var endRow = head && currentPage >= 2 ? currentPage * pageS - 2 : currentPage * pageS - 1; //结束行   
      ...
      tempStr += "<span>" + currentPage + "/" + totalP + "</span>";
      ...
      $(goPage).each(function() {
          $(this).click(function() {
              ...
              if (txt == '首页') {
                  ...
                  $(this).parent().prev().pagination(totalP, psize, head);
              }
          })
      })
  }